  ...
  return (
    <div className="pipeline-container">
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <button className="pipeline-button" onClick={runPipeline}>Run</button>
        <button className="pipeline-button" onClick={stopPipeline}>Stop</button>
        <button className="pipeline-button" onClick={restartPipeline}>Restart</button>
      </div>
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <input
          type="text"
      ...
      <div className="reactflow-container">
        ...
        >
          <MiniMap />
          <Controls />
          <Background color="#00e5ff" gap={16} />
        </ReactFlow>
      </div>
      {taskDetails && (
